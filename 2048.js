...
function HTMLActuator() {
  ...
  this.highScoreContainer= document.getElementsByClassName("highscore-container")[0];
...
HTMLActuator.prototype.updateHighScore = function(score) {
  this.clearContainer(this.highScoreContainer);
  this.highScore = score;
  this.highScoreContainer.textContent = this.highScore;
}
